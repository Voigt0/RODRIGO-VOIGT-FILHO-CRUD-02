...
<body class="">
    ...
    <form method="post">
        ...
        <input type="radio" id="peso" name="busca" value="peso" <?php if($busca == "peso"){echo "checked";}?>>
        <label for="huey"><h3>PESO</h3></label><br>
        <input type="radio" id="altura" name="busca" value="altura" <?php if($busca == "altura"){echo "checked";}?>>
        <label for="huey"><h3>ALTURA</h3></label><br>
